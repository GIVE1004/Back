...
public interface ProfitRepository extends JpaRepository<Profit, Long> {
	...
	@Query("select p from Profit p where p.charity.id = :charityId order by p.baseYearMonth desc limit 3")
	List<Profit> findRecentThreeYearProfitByCharityId(@Param("charityId") Long charityId);
}
